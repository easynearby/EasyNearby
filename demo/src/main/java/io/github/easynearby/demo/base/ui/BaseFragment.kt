package io.github.demo.base.ui
...
import io.github.demo.base.adapter.DeviceAdapter
import io.github.demo.base.adapter.DeviceViewData
import io.github.demo.base.dialogs.InfoDialog
import io.github.easynearby.demo.base.viewmodel.BaseViewModel
import io.github.easynearby.demo.base.viewmodel.ConnectionState
import io.github.easynearby.demo.base.viewmodel.OperationState
import io.github.easynearby.demo.databinding.FragmentBaseBinding
import io.github.easynearby.demo.ui.message.MessageActivity
            ...
            viewModel.connectionState.collect { state ->
                when (state) {
                    ...
                    is ConnectionState.Disconnected -> {
                        adapter.devices.find { it.id == state.connection.id }
                            ?.let { deviceViewData ->
                                adapter.changeDevice(
                                    deviceViewData.copy(
                                        isConnected = false,
